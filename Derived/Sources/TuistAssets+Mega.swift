...
public enum MegaAsset: Sendable {
  ...
  public static let accentColor = MegaColors(name: "AccentColor")
    ...
    public static let doubleCombo = MegaImages(name: "doubleCombo")
    public static let f1 = MegaImages(name: "f1")
    public static let face = MegaImages(name: "face")
    public static let familyComboPack = MegaImages(name: "familyComboPack")
    ...
    public static let insideOutEmo = MegaImages(name: "insideOutEmo")
    public static let kakaoLogo = MegaImages(name: "kakaoLogo")
    public static let knife = MegaImages(name: "knife")
    public static let loveCombo = MegaImages(name: "loveCombo")
    public static let loveComboPack = MegaImages(name: "loveComboPack")
    public static let mapPin = MegaImages(name: "map-pin")
    ...
    public static let pixarCombo = MegaImages(name: "pixarCombo")
    public static let singleCombo1 = MegaImages(name: "singleCombo 1")
    public static let singleCombo = MegaImages(name: "singleCombo")
    ...
    public static let ticketBook = MegaImages(name: "ticketBook")
